...
[Kernel](https://www.onkernel.com/docs/introduction) offers crazy fast browser infrastructure for running browser automations at scale. By integrating with Kernel, you can run Magnitude agents and automations in production with cloud-hosted browsers.
